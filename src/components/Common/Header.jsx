...
class Header extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = { logo: require('./../../images/designlogo.png') };
    }
                        ...
                        <div className="container">
                            <div className="d-flex justify-content-end">
                                <ul className="list-unstyled e-p-bx">
                                    <li><span>Mail us:</span> utsavdodiya.svmr@gmail.com</li>
                                    <li><span>Call us:</span>(+91) 1234-567-890</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div className=" contact-nav-info">
                                                        ...
                                                        <div className="sx-icon-box-wraper left p-b30">
                                                            ...
                                                            <div className="icon-content">
                                                                ...
                                                                <p>utsavdodiya.svmr@gmail.com</p>
                                                            </div>
                                                        </div>
                                                        <div className="sx-icon-box-wraper left p-b30">
