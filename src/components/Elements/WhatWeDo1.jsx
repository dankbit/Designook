...
var bgimg2 = require('./../../images/background/sideimage.jpg');
                            ...
                            <div className="row number-block-one-outer justify-content-center">
                                <div className="col-lg-4 col-md-6 col-sm-6 m-b30">
                                    <div className="number-block-one animate-in-to-top">
                                        <img src={require('./../../images/whatwedo/service1.jpeg')} alt="" />
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 m-b30">
                                    <div className="number-block-one animate-in-to-top">
                                        <img src={require('./../../images/whatwedo/test.jpeg')} alt="" />
                                        <div className="figcaption bg-white text-center p-a20">
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 m-b30">
                                    <div className="number-block-one animate-in-to-top">
                                        <img src={require('./../../images/whatwedo/floorplan.jpeg')} alt="" />
                                        <div className="figcaption bg-white text-center p-a20">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 col-md-12	col-sm-12">
                                        <div className="large-title-info">
                                            <p>Vivid colors and abstract patterns, paired with innovative lighting, textures, and spatial design, transform the outdoor area, enhancing its visual impact.</p>
