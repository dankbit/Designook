...
var bgimg1 = require('./../../images/video_background.jpg');
                            ...
                            <div className="row">
                                <div className="col-xl-6 col-lg-6 col-md-12">
                                    <div className="about-home-3 m-b30 bg-white">
                                        ...
                                        <p>DesignNook is a team of highly talented, experienced, and award-winning architects and designers. Our company has been the leading provider of architecture services to clients throughout the world since 1999. We pay attention to every demand...</p>
